...
# This python script allows safely shutting down a device through a momentary push-to-on button connected to the GPIO pin.
# A LED helps to indicate proper startup of IIAB device and also indicate the status of button press.
# Link to IIAB: https://en.wikipedia.org/wiki/Internet-in-a-Box
# How to use: Holding down the button for about 5 seconds (You can change this time) LED will flash, and IIAB will be shut down safely.
# It needs only three components and connecting wires:
# (1) Push to on button (2) LED (3) Resistor (1000 ohms) (4) Connecting wires (5) PCB (optional)
...
# Using a momentary push button without a pull-up resistor (using internal pull-up).
